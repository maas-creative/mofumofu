...
export function getPackageDir(): string {
	...
	const envDir = process.env.MOFU_PACKAGE_DIR || process.env.PI_PACKAGE_DIR;
	if (envDir) {
...
const DEFAULT_SHARE_VIEWER_URL = "https://mofumofu.local/session/";

/** Get the share viewer URL for a gist ID */
export function getShareViewerUrl(gistId: string): string {
	const baseUrl = process.env.MOFU_SHARE_VIEWER_URL || process.env.PI_SHARE_VIEWER_URL || DEFAULT_SHARE_VIEWER_URL;
	return `${baseUrl}#${gistId}`;
}

// =============================================================================
// User Config Paths (~/.mofumofu/agent/*)
// =============================================================================

/** Get the agent config directory (e.g., ~/.mofumofu/agent/) */
